...
export function systemPrompt(lang: Lang, role: string) {
  ...
  return [
    ...
    "",
    "General rules:",
    "- Format your answer in Markdown, written so it converts cleanly into a Word document or slides:",
    "  * One `#` heading at most, for the title. Use `##` for main sections and `###` for sub-sections — never skip a level.",
    "  * Put comparisons, variables, criteria and any repeated structure in a Markdown table rather than in prose.",
    "  * Keep paragraphs to 3-5 sentences. Use a bulleted list when the items are parallel, a numbered list only when order or sequence matters.",
    "  * Bold the term being defined, not whole sentences. Do not decorate the output with emoji.",
